...
<div class="bg-white border rounded-lg shadow-lg px-6 py-8 max-w-md mx-auto mt-8">
    ...
    <div class="mb-8">
        ...
        <div class="text-gray-700 mb-2">Name:{{ $driverName}}</div>
        <div class="text-gray-700 mb-2">Phone Number: 254{{ $driverPhoneNumber }}</div>
        <div class="text-gray-700 mb-2">Licence Number:{{ $driverLicenceNumber }}</div>
        <div class="text-gray-700">ID/Alien card Number: {{ $driverIdNumber }}</div>
    </div>
...
<div class="text-center mt-8">
    ...
    <a href="/payment/success/{{ $ticketId }}/download" class="download-link">Download Receipt</a>
</div>
